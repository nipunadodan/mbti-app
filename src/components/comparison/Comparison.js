    ...
    return (
        <div className={'container mx-auto'}>
            <div className={'flex justify-center flex-col text-center p-8'}>
                <h1 className={'text-8xl mb-4 inline-block'}>Compare MBTI</h1>
                <div className={'mt-6'}>
                    <input className={'w-1/3 border border-gray-400 focus:border-blue-500 outline-0 rounded p-3 mr-3'}
...

            {
                (inputs.mbti1 !== '' && inputs.mbti2 !== '')
                    ?   <div className={'grid grid-cols-2 gap-6 mt-20 mb-8'}>
                            <div className={''}>
                                    ...
                                    mbti[inputs.mbti1].map((x,i) => {
                                        return (
                                            <div className={'my-6'}>
                                                ...
                                                <p className={'mt-3 text-gray-500 italic border-l-4 border-gray-200 px-2 py-1'}>{func_order[i].name}</p>
